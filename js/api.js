...
function displayProducts (products) {
  ...
  for (let i = 0; i < displayedProducts; i++) {
    ...
    <div class="mt-4 px-5 pb-5 flex flex-col">
      ...
      <button href="#" id="buy-button" class="flex items-center justify-center h-10 rounded-md bg-slate-900 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-blue-300">
